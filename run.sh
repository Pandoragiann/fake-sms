  ...
  echo -e ${YELLOW}"           Coded By: Pandoragiann                                 #"
  echo -e ${GREEN}"            https://twiter.com/pandoragiann                        #"
  echo -e ${RED}"######################################################################"
  ...
  sleep 0.5
  echo  -e ${CNC}"4. Full usage: 92355310222\n"
    sleep 0.5
  ...
  function SENDSMS() {
      ...
      banner
      echo ""
     echo -e ${ORANGE}"Enter Phone Number With Country Code Like (693666492)\n"
  ...
  sleep 1
  echo ""
  echo -e ${YELLOW}"[*] Thanks For Using Fake-SMS developed by  +255693666492 :)"
  exit
  }
